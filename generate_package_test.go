...
Sub-packages:<ul><li><a href="/pkg1/subpkg1">example.com/pkg1/subpkg1</a></li><li><a href="/pkg1/subpkg2">example.com/pkg1/subpkg2</a></li></ul></div>
		...
		{
			description: "bitbucket defaults",
			domain:      "example.com",
			pkg:         "pkg1",
			r: repository{
				Prefix: "pkg1",
				Subs:   []sub{{Name: "subpkg1"}, {Name: "subpkg2"}},
				URL:    "https://bitbucket.org/example/go-pkg1",
			},
			expectedOut: `<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
<meta name="go-import" content="example.com/pkg1 git https://bitbucket.org/example/go-pkg1">
<meta name="go-source" content="example.com/pkg1 https://bitbucket.org/example/go-pkg1 https://bitbucket.org/example/go-pkg1/src/master{/dir} https://bitbucket.org/example/go-pkg1/src/master{/dir}/{file}#lines-{line}">
<style>
* { font-family: sans-serif; }
body { margin-top: 0; }
.content { display: inline-block; }
...
<code>import "example.com/pkg1"</code>
Home: <a href="https://godoc.org/example.com/pkg1">https://godoc.org/example.com/pkg1</a><br/>
Source: <a href="https://bitbucket.org/example/go-pkg1">https://bitbucket.org/example/go-pkg1</a><br/>
Sub-packages:<ul><li><a href="/pkg1/subpkg1">example.com/pkg1/subpkg1</a></li><li><a href="/pkg1/subpkg2">example.com/pkg1/subpkg2</a></li></ul></div>
</body>
</html>`,
			expectedErr: nil,
